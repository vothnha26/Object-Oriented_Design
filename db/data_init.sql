...
TRUNCATE TABLE `percentage_promotion_details`;
TRUNCATE TABLE `value_promotion_details`;
TRUNCATE TABLE `promotion_details`;
...
-- 6. Promotion Details (Strategy Pattern)
INSERT INTO `promotion_details` (`id`, `min_order_amount`) VALUES (1, 50000.00), (2, 0.00), (3, 100000.00);

INSERT INTO `value_promotion_details` (`id`, `discount_value`) VALUES (1, 10000.00), (2, 5000.00);
INSERT INTO `percentage_promotion_details` (`id`, `discount_rate`, `max_discount_amount`) VALUES (3, 15, 30000.00);

-- 7. Promotions
INSERT INTO `promotions` (`id`, `name`, `code`, `description`, `start_date`, `end_date`, `image_url`, `promotion_detail_id`)
VALUES
(1, 'Khuyến mãi mùa Noel', 'NOEL2025', 'Mùa Noel, giảm giá đậm sâu', '2025-11-01', '2025-12-31', NULL, 1),
(2, 'Năm mới - Tuổi mới', 'NEWYEAR2026', 'Ưu đãi toàn menu', '2026-01-01', '2026-01-10', NULL, 2),
(5, 'Valentine', 'VALENTINE', 'Khuyến mãi lễ tình nhân', '2026-02-01', '2026-02-20', NULL, 3);

-- 8. Customers (Password: password)
INSERT INTO `customers` (`id`, `username`, `password_hash`, `email`, `full_name`, `phone`, `status`)
VALUES
(1, 'phuoc', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'khanh@example.com', 'Nguyễn Phước Tài', '0912345678', 'ACTIVE'),
(2, 'tai', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'tai@example.com', 'Tài Phước', '0987654321', 'ACTIVE'),
(3, 'sang', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'dinhsang1105@gmail.com', 'Phan Đình Sáng', '123123123', 'ACTIVE'),
(9, 'hoang', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'phuochoa2021vg@gmail.com', 'Hồng Phước Hòa', '12512235', 'ACTIVE'),
(10, 'noname012', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'daisyprof205@gmail.com', 'sáng phan', '0123554158', 'ACTIVE');

-- 9. Employees (Password: password)
INSERT INTO `employees` (`id`, `username`, `password_hash`, `email`, `full_name`, `phone`, `role`, `status`)
VALUES
(1, 'admin', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'admin@trasua.com', 'Nguyễn Quản Lý', '0900000001', 'ADMIN', 'ACTIVE'),
(3, 'phuochoa', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'hoahp@gmail.com', 'Hong Phuoc Hoa', '0999888777', 'STAFF', 'ACTIVE'),
(5, 'noname', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', 'sangphan@gmail.com', 'Nguyễn A', '5246624422', 'STAFF', 'ACTIVE');
...
-- 11. Orders
INSERT INTO `orders` (`id`, `customer_id`, `employee_id`, `promotion_id`, `status`, `created_at`)
VALUES
(1, 1, 1, 1, 'DELIVERED', '2025-10-03 12:52:38'),
(2, 3, 3, NULL, 'DELIVERED', '2025-10-05 13:54:38'),
(14, 3, 3, NULL, 'DELIVERED', '2025-10-05 19:03:37');
...
-- 15. Reviews
INSERT INTO `reviews` (`id`, `user_id`, `product_id`, `stars`, `comment`, `admin_reply`)
VALUES
(1, 1, 1, 5, 'Rất ngon!', 'Cảm ơn bạn đã ủng hộ!'),
(2, 3, 8, 5, 'Trà đào thơm lắm', NULL);

-- 16. Wishlists
INSERT INTO `wishlists` (`id`, `customer_id`, `product_id`, `added_at`)
VALUES
(1, 3, 1, '2025-10-06 09:00:00'),
(2, 1, 3, '2025-10-06 09:05:00');
