...
public class StatsService {
    ...
    public DashboardStats loadDashboardStats() {
        ...
        // Table: Orders, Column: TongThanhToan, PaymentStatus (from Payment table)
        s.totalRevenue = nnBig(queryBigDecimal("SELECT SUM(dh.TongThanhToan) FROM Orders dh LEFT JOIN Payment p ON p.OrderId = dh.MaDH WHERE p.Status='PAID'"));
